...
const Contact = () => {
  ...
  return (
    <>
      <section className="relative bg-white py-20 px-4 lg:py-[100px]">
          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 text-[32px] font-bold uppercase text-black-600 sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="mb-9 text-base leading-relaxed text-body-color">
                    Leave a message, and we'll get in touch shortly.

                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-red-500 sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
              ...
              <div className="relative rounded-lg bg-white p-4 shadow-lg sm:p-12 border-2 border-indigo-300">
                <form onSubmit={handleSubmit} action="https://formspree.io/f/xkndvdoy" method="POST">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-indigo-600 bg-indigo-600 p-3 text-white transition hover:bg-opacity-90"
                    >
                      Let's Talk
                    </button>
                  </div>

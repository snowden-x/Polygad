        ...
        <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
            <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="mt-3 text-xl leading-relaxed text-gray-600 md:mt-8"></p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 mt-10 text-center lg:mt-24 sm:gap-x-8 md:grid-cols-3">
                    ...
                    <div>
                        <h3 className="font-bold text-7xl">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-blue-600"> 8823 </span>
                        </h3>
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-xl font-medium text-gray-900">Partners</p>
                        <p className="text-base mt-0.5 text-gray-500">Working for excellence</p>
                    </div>
                </div>
            </div>
        </section>
